...
Unlike traditional visualization tools, ClaudeMap organizes your code by what it actually does. Claude reads your project and groups it into concepts in a way you actually think about your project. Zoom out to see the big picture. Zoom in to see the details. Colors show what's healthy and what's broken. Use `/explain` and ask any question about your code — Claude will present directly on the map and explain step by step.
...
[Play with ClaudeMap's map](https://quinnaho.github.io/claudemap/) — this is a standalone preview of the visual map. The full experience with Claude-powered explanations, walkthroughs, and live updates requires the Claude Code integration below.
